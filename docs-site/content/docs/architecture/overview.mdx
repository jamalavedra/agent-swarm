...
- Handles integrations (Slack, GitHub, GitLab, AgentMail webhooks)
...
- **Workflow Engine** — Event-driven DAG executor that processes workflow triggers, conditions, and actions (see [Workflows](/docs/concepts/workflows))
...
| AI Runtime | Claude Code (headless) or pi-mono (via `HARNESS_PROVIDER`) |
