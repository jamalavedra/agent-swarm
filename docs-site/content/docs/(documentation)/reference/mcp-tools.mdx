...
- **Deferred tools** (65) — Discovered on demand via Claude Code's Tool Search when the agent needs them (scheduling, epics, config, skills, workflows, file operations, etc.)
