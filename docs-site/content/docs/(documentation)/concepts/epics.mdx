---
title: Epics
description: Group related tasks into epics to track multi-step projects, monitor progress, and coordinate work across agents
---
...
- [Task Lifecycle](/docs/concepts/task-lifecycle) — How individual tasks flow through the swarm
- [MCP Tools Reference](/docs/reference/mcp-tools) — Epic management tools (create-epic, get-epic-details, etc.)
- [Epics API Reference](/docs/api-reference/epics) — REST API endpoints for creating and managing epics
